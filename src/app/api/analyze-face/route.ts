...
<<<<<<< HEAD
    ...
    "---\n\n" +
    "### SUMMARY TABLE\n\n" +
    "| Region/Group | Estimated Percentage | Key Traits & Justification | Percentage of country and tribe\n" +
    "|--------------|---------------------|---------------------------|\n" +
    "| [Region/Group 1] | [Percentage]% | [Key traits/justification] | [each Country and tribe breakdown per total Percentage of region]\n" +
    "| [Region/Group 2] | [Percentage]% | [Key traits/justification] | [each Country and tribe breakdown per total Percentage of region]\n" +
    "| [Region/Group 3] | [Percentage]% | [Key traits/justification] | [each Country and tribe breakdown per total Percentage of region]\n\n" +
=======
    "- **[Region/Group Name]:** [Percentage]%\n    - [Key traits/justification]\n" +
    "Repeat for as many regions/groups as are detected, without limiting the number. Do not omit any detected region or group.\n\n" +
    "---\n\n" +
