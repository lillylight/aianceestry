      ...
      {showDisclaimer ? (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4">
            <h3 className="text-2xl font-bold text-center mb-4">🎉 Special Offer!</h3>
            <div className="text-center mb-6">
              <p className="text-gray-700 mb-4">
                For today only, get your ancestry analysis for FREE!
              </p>
              <p className="text-gray-600 mb-6">
                Simply share and follow @Aiancestry on Twitter. Feel free to tag us!
              </p>
              <TwitterShareButton
                url="https://aiancestry.com"
                title="I just discovered I'm ...% [Your Ancestry] using @Aiancestry! 🌍 Only $1 and got my results in 30 seconds! #Ancestry #AI"
                className="w-full mb-4"
              >
                <button className="w-full py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-full font-medium">
                  Share on Twitter
                </button>
              </TwitterShareButton>
              <button
                onClick={handleFreeTrial}
                className="w-full py-3 bg-green-500 hover:bg-green-600 text-white rounded-full font-medium"
              >
                Confirm Free Trial
              </button>
              <button
                onClick={handleCloseFreeTrial}
                className="w-full py-3 bg-gray-300 hover:bg-gray-400 text-gray-700 rounded-full font-medium mt-4"
              >
                Skip Free Trial
              </button>
            </div>
